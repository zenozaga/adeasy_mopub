...
class _AdEasyMopubWidgetState extends State<AdEasyMopubWidget> {
  ...
  static const String BANNER_RECTANGLE_UNIT_ID =
      "252412d5e9364a05ab77d9396346d73d";
  ...
  void showInterstitial() async {
    AdEasyMopub.instance.showInterstitial(INTERSTITIAL_UNIT_ID,
        AdEasyListener(onClose: () {
      setState(() {
  ...
  void showReward() async {
    ...
    listener = AdEasyListener(onClose: () {
      ...
      if (listener!.hasData()) {
        ...
        alert(title: "Reward Details", body: [
  ...
  Future<void> initAdEasyMopub() async {
    await AdEasyMopub.instance
        .init(testMode: true, adUnitID: INTERSTITIAL_UNIT_ID, adConsent: true);
